<template>
  ...
  >
    <div class="flex items-center gap-3">
      ...
      <div>
        <p class="text-xs uppercase tracking-[0.35em] text-muted-foreground">App</p>
        <h2 class="text-lg font-semibold text-foreground">sentio</h2>
      </div>
    </div>

    <div
      class="my-5 h-px bg-gradient-to-r from-transparent via-border/40 to-transparent"
    ></div>
